...
export function CompanyDetailModal({ isOpen, onClose, company }: CompanyDetailModalProps) {
  ...
  const statusConfig = {
    [CompanyStatus.ACTIVE]: { label: 'Đang hoạt động', color: 'text-green-600 bg-green-100 dark:bg-green-900/30 dark:text-green-400' },
    [CompanyStatus.PENDING]: { label: 'Chờ duyệt', color: 'text-yellow-600 bg-yellow-100 dark:bg-yellow-900/30 dark:text-yellow-400' },
    [CompanyStatus.SUSPENDED]: { label: 'Tạm ngưng', color: 'text-red-600 bg-red-100 dark:bg-red-900/30 dark:text-red-400' },
    [CompanyStatus.INACTIVE]: { label: 'Ngừng hoạt động', color: 'text-gray-600 bg-gray-100 dark:bg-gray-700 dark:text-gray-400' }
  };
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className={`px-3 py-1 rounded-full text-sm font-medium ${statusConfig[company.status]?.color || 'bg-gray-100 text-gray-600'}`}>
                  {statusConfig[company.status]?.label || 'Không xác định'}
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-sm text-purple-600 dark:text-purple-400">Nhà xe</span>
                </div>
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-sm text-blue-600 dark:text-blue-400">Xe khách</span>
                </div>
              ...
              <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-xl">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-sm text-green-600 dark:text-green-400">Chuyến đi</span>
                </div>
              ...
              <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-sm text-yellow-600 dark:text-yellow-400">Lượt khách</span>
                </div>
                <p className="text-2xl font-bold text-yellow-700 dark:text-yellow-300">
                  {/* Tạm thời hiển thị 0 vì không có totalBookings */}
                  0
                </p>
              </div>
            </div>
            ...
            <div className="p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium text-green-700 dark:text-green-300">Tổng doanh thu</span>
                </div>
              </div>
            ...
            <div className="p-4 bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-2xl">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium text-orange-700 dark:text-orange-300">Đánh giá trung bình</span>
                </div>
              </div>
