...
dashboardTitle: 'Tổng quan hệ thống',
    ...
    startDate: 'Tháng/Ngày bắt đầu',
    endDate: 'Tháng/Ngày kết thúc',
...
dashboardTitle: 'System Overview',
    ...
    searchReviews: 'Search content, customer name...',
    allRating: 'All ratings',
    stars: 'Stars',
    noComment: 'No comment content.',
    confirmDeleteReview: 'This action will permanently delete the feedback. Are you sure?',
    errorFetchingReviews: 'Error fetching review data.',
    searchUsers: 'Search name, email, phone...',
    totalSpent: 'Total spent',
    companyAdminRoleLabel: 'Company Admin',
    userRole: 'Customer',
    systemAdmin: 'Super Admin',
    startDate: 'Start Month/Date',
    endDate: 'End Month/Date',
