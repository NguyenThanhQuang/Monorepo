...
export const API_ENDPOINTS = {
  ...
  TRIPS: {
    ...
    SEARCH_ROUTE: "/trips/search/route", // (optional) nếu bạn muốn dùng searchByRoute
  },

  BOOKINGS: {
    BASE: "/bookings",
    CREATE: "/bookings",
    HOLD: "/bookings/hold", // ✅ thêm
    USER_BOOKINGS: "/users/me/bookings",
    CANCEL: "/bookings/:id",
    REFUND: "/bookings/:id/refund",
    MOCK_CONFIRM_PAYMENT: "/bookings/confirm/:id", // ✅ nếu bạn dùng cái này
  },
