...
export function VerifyEmailPage() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl max-w-md w-full animate-scale-in">
        <div className="p-6">
          {/* HEADER */}
          ...
          {status === "success" && (
            <div className="text-center space-y-4">
              ...
              <button
                ...
                className="w-full mt-4 py-3 bg-linear-to-r from-blue-600 to-teal-500 text-white rounded-2xl"
              >
                Vào trang chủ ngay
              </button>
            </div>
          ...
          {status === "error" && (
            <div className="text-center space-y-4">
              ...
              <div className="space-y-3 mt-4">
                <button
                  onClick={() => navigate("/")}
                  className="w-full py-3 bg-linear-to-r from-blue-600 to-teal-500 text-white rounded-2xl"
                >
                  Về trang chủ
                </button>
              </div>
