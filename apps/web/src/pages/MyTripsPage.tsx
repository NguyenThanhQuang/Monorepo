          ...
          <div className="bg-[#1e293b] rounded-2xl p-12 text-center">
            ...
            <p className="text-gray-400 mb-6">
              {selectedTab === 'all' 
                ...
                : `Không có chuyến đi ${selectedTab === 'upcoming' ? 'sắp tới' : 
...
/* ===== TAB BUTTON ===== */
function TabButton({ children, active, onClick }: { children: string; active: boolean; onClick: () => void }) {
  return (
    <button
      onClick={onClick}
...
function BookingCard({
  ...
  return (
    <div className="bg-[#1e293b] rounded-2xl p-6 hover:bg-[#2d3a4f] transition-all cursor-pointer"
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 text-sm text-gray-400">
            ...
            <div className="flex items-center gap-1">
              ...
              <span>{booking.passengers?.length || 0} ghế</span>
            </div>
          </div>
...
function BookingDetailsModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-[#020617] rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        {/* Header */}
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-right">
                {booking.tripId?.route?.fromLocationId?.fullAddress || 'N/A'}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#0f172a] p-4 rounded-xl mb-6">
          ...
          <div className="mt-4">
            <h5 className="text-sm text-gray-400 mb-2">Danh sách ghế:</h5>
        ...
        <div className="flex gap-3">
          {canReview && (
            <button
              ...
              className="flex-1 py-3 bg-yellow-600 hover:bg-yellow-700 rounded-xl font-medium transition-colors"
            >
